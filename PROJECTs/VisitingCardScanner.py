...
m2.add_command(label = '|| Computer Science & engineering student ||', 
			font = ('Times', 13))
...
m3.add_command(label = 'E-mail: shikherjain786@gmail.com', 
			font = ('Times', 13))
m3.add_separator()
m3.add_command(label = 'Mobile: +91-7452017544', font=('Times', 13))
m3.add_separator()
m3.add_command(label = 'LinkedIn: https://www.linkedin.com/in/shikher-jain-0bb8a8259',
			font = ('Times', 13))
root.config(menu = mainmenu)
...
Label(text='©copyright 2024', bg='#433E3B', fg='white',
	font=('Times', 10)).pack(side='bottom', fill='x')
Label(text='Developer: Shikher Jain', bg='#433E3B', fg='white',
